...
const EcommerceWidgets = () => {
    ...
    const confirmPayment = (): void => {
        ...
        //   const payamount = checkedElem?.querySelector(".pay-amount")?.innerHTML;
            // const payamount = (checkedElem && checkedElem.querySelector(".pay-amount"))?.innerHTML;
            // const payamount = checkedElem?.querySelector(".pay-amount")?.innerHTML || '';
            let payamount = '';

            if (checkedElem) {
                const payElement = checkedElem.querySelector(".pay-amount");
                if (payElement) {
                    payamount = payElement.innerHTML;
                }
            }
