...
import { ContasPagarList, ContasPagarSearch } from "interfaces/ContasContasPagar";
...
export interface ContasPagarTableProps {
    data: PaginateInterface<ContasPagarList> | undefined,
    getData: (data: PaginateSearch & ContasPagarSearch) => void,
...
export const ContasPagarTable = ({ data, getData, setPerPage, setPage, perPage, filters }: ContasPagarTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            const response = await contasPagarService.deleteContasPagar(id);
            if (data) {
                                                                                ...
                                                                                <ButtonGroup>
                                                                                    <UncontrolledDropdown direction="down">
                                                                                        ...
                                                                                        <DropdownMenu style={{ zIndex: '999' }}>
                                                                                            <Link to={`/ContasPagar/edit/${row.id}`} state={{ source: row }}>
