...
import { ProdutosModel, ProdutosSearch } from "interfaces/Produtos/ProdutosInterface";
...
const ProdutosFilter = ({ getRemoteProdutosList }: ProdutosFilterProps) => {
    ...
    const { handleSubmit, control, setValue, register, watch } = useForm<ProdutosSearch>({ defaultValues: {} })
                ...
                <Col xs={12}>
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div className='d-sm-flex align-items-center justify-content-between'>
                            ...
                            <h4 className="mb-sm-0 ms-3">Produtos</h4>
                        </div>
                            ...
                            <Row>
                                <Col>
                                    <Collapse isOpen={showFilter} id="multiCollapseExample2" className="multi-collapse mt-3">
                                        <div className="">
                                            <form className="px-0 my-0 m-2" id="form-search" name="form-search" onSubmit={handleSubmit(getRemoteProdutosList)}>
                                                <Row>
                                                    <Col md={5}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="descricao" className="form-label">Produto</Label>
                                                            <AsyncSelectListControlled<ProdutosSearch>
                                                ...
                                                <Row className="mt-5">
                                                    <div className="d-flex flex-row justify-content-end align-items-center" >
                                                        ...
                                                        <Col md={6}>
                                                            <div className="ms-4 ">
                                                                <InputTextControlled<ProdutosSearch> field={"palavra_chave"} control={control} placeholder="Buscar..." />
                                                            </div>
                                                        </Col>
