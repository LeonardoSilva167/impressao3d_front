...
import { ProdutosSearch } from 'interfaces/Produtos/ProdutosInterface'
...
const ProdutosFilter = ({ getRemoteProdutosList }: ProdutosFilterProps) => {
    const { handleSubmit, control } = useForm<ProdutosSearch>({ defaultValues: {} })
                                            ...
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        ...
                                                        <InputTextControlled<ProdutosSearch>
                                                            field={'codigo_base'}
                                                            control={control}
                                                            placeholder="Código..."
                                                        />
                                                ...
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <label htmlFor="descricao_produto" className="form-label">Descrição</label>
                                                        <InputTextControlled<ProdutosSearch>
                                                ...
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <label htmlFor="sku_base" className="form-label">SKU Base</label>
                                                        <InputTextControlled<ProdutosSearch>
                                                            field={'sku_base'}
                                                            control={control}
                                                            placeholder="SKU..."
