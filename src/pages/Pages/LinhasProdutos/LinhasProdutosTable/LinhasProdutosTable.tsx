...
export const LinhasProdutosTable = ({ data, getData, setPerPage, setPage, perPage, filters }: LinhasProdutosTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            const response = await linhasProdutosService.deleteLinhasProdutos(id);
            if (data) {
