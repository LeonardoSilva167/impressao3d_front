...
const LinhasProdutosForm = () => {
    ...
    const [record] = useState<LinhasProdutosModel>(state ? state.source : LinhasProdutosDefaultValues)
    const { handleSubmit, control, setValue } = useForm<LinhasProdutosModel>({
                            ...
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <div className="d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 className="mb-sm-0 ms-3">
                                        {record.id ? 'Editar' : 'Adicionar'} Linha de Produto
                                    </h4>
                                </div>
