...
const RankingServicosDash = ({range}: WidgetsProps) => {
    ...
    //         try {
    //             const dadosAPI = await dashboardsService.listRankingServicosDashboards({
                                        ...
                                        return (    
                                            <tr>
                                                ...
                                                <td className='text-end'>
                                                    <h5 className="fs-14 my-1 fw-normal">R$ {formatarParaMoedaSemSimbolo(row.preco_medio)}</h5>
                                                    <span className="text-muted">Preço Médio</span>
                                                </td>
                                                <td className='text-end'>
                                                    <h5 className="fs-14 my-1 fw-normal">{row.total_qtd}</h5>
                                                    <span className="text-muted">Serviços</span>
                                                </td>
                                                <td className='text-end'>
                                                    <h5 className="fs-14 my-1 fw-normal">R$ {formatarParaMoedaSemSimbolo(row.total_valor)}</h5>
...
export default RankingServicosDash;