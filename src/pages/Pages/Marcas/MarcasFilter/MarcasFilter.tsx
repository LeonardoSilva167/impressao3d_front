...
import { MarcasSearch } from "interfaces/Marcas/MarcasInterface"

export interface MarcasFilterProps {
    getRemoteMarcasList: (data: any) => void
}

const MarcasFilter = ({ getRemoteMarcasList }: MarcasFilterProps) => {
    const { handleSubmit, control, register } = useForm<MarcasSearch>({ defaultValues: {} })
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteMarcasList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteMarcasList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <label htmlFor="descricao" className="form-label">Descrição</label>
                                                        <InputTextControlled<MarcasSearch>
                                                            field={"descricao"}
                                                            control={control}
