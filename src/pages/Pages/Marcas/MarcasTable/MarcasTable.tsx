...
export interface MarcasTableProps {
    data: PaginateInterface<MarcasList> | undefined
    getData: (data: PaginateSearch & MarcasSearch) => void
...
export const MarcasTable = ({ data, getData, setPerPage, setPage, perPage, filters }: MarcasTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await marcasService.deleteMarcas(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/marcas/edit/${row.id}`} state={{ source: row }}>
