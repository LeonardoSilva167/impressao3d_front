...
export interface FilamentosTableProps {
    ...
    getData: (data: PaginateSearch & FilamentosSearch) => void
...
export const FilamentosTable = ({ data, getData, setPerPage, setPage, perPage, filters }: FilamentosTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await filamentosService.deleteFilamentos(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/filamentos/view/${row.id}`} state={{ source: row }}>
...
export default FilamentosTable
