...
export interface CategoriasProdutosTableProps {
    data: PaginateInterface<CategoriasProdutosList> | undefined
    getData: (data: PaginateSearch & CategoriasProdutosSearch) => void
...
export const CategoriasProdutosTable = ({ data, getData, setPerPage, perPage }: CategoriasProdutosTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await categoriasProdutosService.deleteCategoriasProdutos(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/categorias-produtos/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link>
                                                                                    <Link to={`/categorias-produtos/edit/${row.id}`} state={{ source: row }}>
            ...
            <Row>
                <Col md={12}>
                    <div className="hstack gap-2 justify-content-end">
                        <Link to="/categorias-produtos" className="btn btn-soft-success">Voltar</Link>
                    </div>
                </Col>
            </Row>
        </React.Fragment>
...
export default CategoriasProdutosTable
