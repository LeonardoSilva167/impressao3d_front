...
import { CategoriasProdutosSearch } from "interfaces/CategoriasProdutos/CategoriasProdutosInterface"

export interface CategoriasProdutosFilterProps {
    getRemoteCategoriasProdutosList: (data: any) => void
}

const CategoriasProdutosFilter = ({ getRemoteCategoriasProdutosList }: CategoriasProdutosFilterProps) => {
    const { handleSubmit, control, register } = useForm<CategoriasProdutosSearch>({ defaultValues: {} })
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteCategoriasProdutosList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteCategoriasProdutosList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <label htmlFor="codigo" className="form-label">Código</label>
                                                        <InputTextControlled<CategoriasProdutosSearch>
                                                            field={"codigo"}
                                                            control={control}
                                                            placeholder="Código..."
                                                        />
...
export default CategoriasProdutosFilter
