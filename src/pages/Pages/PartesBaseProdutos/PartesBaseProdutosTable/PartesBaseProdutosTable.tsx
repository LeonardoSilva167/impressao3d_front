...
export interface PartesBaseProdutosTableProps {
    data: PaginateInterface<PartesBaseProdutosList> | undefined
    getData: (data: PaginateSearch & PartesBaseProdutosSearch) => void
...
export const PartesBaseProdutosTable = ({ data, getData, setPerPage, perPage }: PartesBaseProdutosTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await partesBaseProdutosService.deletePartesBaseProdutos(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/partes-base-produtos/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link>
                                                                                    <Link to={`/partes-base-produtos/edit/${row.id}`} state={{ source: row }}>
            ...
            <Row>
                <Col md={12}>
                    <div className="hstack gap-2 justify-content-end">
                        <Link to="/partes-base-produtos" className="btn btn-soft-success">Voltar</Link>
                    </div>
                </Col>
            </Row>
        </React.Fragment>
...
export default PartesBaseProdutosTable
