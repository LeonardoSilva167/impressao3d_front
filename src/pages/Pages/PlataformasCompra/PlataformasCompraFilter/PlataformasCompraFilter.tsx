...
import { PlataformasCompraSearch } from "interfaces/PlataformasCompra/PlataformasCompraInterface"

export interface PlataformasCompraFilterProps {
    getRemotePlataformasCompraList: (data: any) => void
}

const PlataformasCompraFilter = ({ getRemotePlataformasCompraList }: PlataformasCompraFilterProps) => {
    const { handleSubmit, control, register } = useForm<PlataformasCompraSearch>({ defaultValues: {} })
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemotePlataformasCompraList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemotePlataformasCompraList)}
                                        >
                                            <Row>
                                            </Row>
                                            <Row className="mt-5">
                                                <div className="d-flex flex-row justify-content-end align-items-center">
                                                    <Col md={6}>
                                                        <InputTextControlled<PlataformasCompraSearch>
                                                            field={"palavra_chave"}
                                                            control={control}
                                                            placeholder="Buscar..."
                                                        />
...
export default PlataformasCompraFilter
