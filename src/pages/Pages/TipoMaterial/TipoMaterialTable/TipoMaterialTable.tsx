...
export interface TipoMaterialTableProps {
    data: PaginateInterface<TipoMaterialList> | undefined
    getData: (data: PaginateSearch & TipoMaterialSearch) => void
...
export const TipoMaterialTable = ({ data, getData, setPerPage, setPage, perPage, filters }: TipoMaterialTableProps) => {
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/tipo-material/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link>
                                                                                    <Link to={`/tipo-material/edit/${row.id}`} state={{ source: row }}>
