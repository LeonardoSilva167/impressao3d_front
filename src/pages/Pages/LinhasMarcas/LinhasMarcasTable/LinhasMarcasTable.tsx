...
export interface LinhasMarcasTableProps {
    data: PaginateInterface<LinhasMarcasList> | undefined
    getData: (data: PaginateSearch & LinhasMarcasSearch) => void
...
export const LinhasMarcasTable = ({ data, getData, setPerPage, setPage, perPage, filters }: LinhasMarcasTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await linhasMarcasService.deleteLinhasMarcas(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    {/* <Link to={`/linhas-marcas/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link> */}
                                                                                    <Link to={`/linhas-marcas/edit/${row.id}`} state={{ source: row }}>
...
export default LinhasMarcasTable
