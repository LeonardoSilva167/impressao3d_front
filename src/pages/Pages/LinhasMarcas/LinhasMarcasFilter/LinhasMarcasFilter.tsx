...
import { LinhasMarcasSearch } from "interfaces/LinhasMarcas/LinhasMarcasInterface"

export interface LinhasMarcasFilterProps {
    getRemoteLinhasMarcasList: (data: any) => void
}

const LinhasMarcasFilter = ({ getRemoteLinhasMarcasList }: LinhasMarcasFilterProps) => {
    const { handleSubmit, control, register } = useForm<LinhasMarcasSearch>({ defaultValues: {} })
                ...
                <Col xs={12}>
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <h4 className="mb-0">Linhas de Marcas</h4>
                        </div>
                        <Breadcrumb pageTitle="" listClassName="mb-sm-0 pt-1 py-2">
                            <BreadcrumbItem><Link to="/dashboard"><i className="ri-home-5-fill"></i></Link></BreadcrumbItem>
                            <BreadcrumbItem active>Linhas de Marcas</BreadcrumbItem>
                        </Breadcrumb>
                    </div>
                </Col>
            </Row>
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteLinhasMarcasList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteLinhasMarcasList)}
                                        >
                                            <Row>
                                            ...
                                            <Row className="mt-5">
                                                <div className="d-flex flex-row justify-content-end align-items-center">
                                                    <Col md={6}>
                                                        <InputTextControlled<LinhasMarcasSearch>
                                                            field={"palavra_chave"}
                                                            control={control}
                                                            placeholder="Buscar..."
                                                        />
...
export default LinhasMarcasFilter
