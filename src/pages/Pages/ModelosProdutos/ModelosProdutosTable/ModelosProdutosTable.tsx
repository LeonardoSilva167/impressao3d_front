...
export interface ModelosProdutosTableProps {
    data: PaginateInterface<ModelosProdutosList> | undefined
    getData: (data: PaginateSearch & ModelosProdutosSearch) => void
...
export const ModelosProdutosTable = ({ data, getData, setPerPage, perPage }: ModelosProdutosTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await modelosProdutosService.deleteModelosProdutos(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/modelos-produtos/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link>
                                                                                    <Link to={`/modelos-produtos/edit/${row.id}`} state={{ source: row }}>
            ...
            <Row>
                <Col md={12}>
                    <div className="hstack gap-2 justify-content-end">
                        <Link to="/modelos-produtos" className="btn btn-soft-success">Voltar</Link>
                    </div>
                </Col>
            </Row>
        </React.Fragment>
...
export default ModelosProdutosTable
