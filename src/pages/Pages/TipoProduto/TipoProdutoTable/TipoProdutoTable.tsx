...
export interface TipoProdutoTableProps {
    data: PaginateInterface<TipoProdutoList> | undefined,
    getData: (data: PaginateSearch & TipoProdutoSearch) => void,
...
export const TipoProdutoTable = ({ data, getData, setPerPage, setPage, perPage, filters }: TipoProdutoTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            const response = await tipoProdutoService.deleteTipoProduto(id);
            if (data) {
