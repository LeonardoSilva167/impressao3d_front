...
export interface ContasBancariasFilterProps {
    getRemoteContasBancariasList: (data: any) => void
}

const ContasBancariasFilter = ({ getRemoteContasBancariasList }: ContasBancariasFilterProps) => {
    ...
    const { handleSubmit, control, setValue, register, watch } = useForm<ContasBancariasSearch>({ defaultValues: {} })
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter &&
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteContasBancariasList)} >
                            ...
                            <Row>
                                <Col>
                                    <Collapse isOpen={showFilter} id="multiCollapseExample2" className="multi-collapse mt-3">
                                        <div className="">
                                            <form className="px-0 my-0 m-2" id="form-search" name="form-search" onSubmit={handleSubmit(getRemoteContasBancariasList)}>
                                                <Row>
                                                    <Col md={4}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="tipo_lancamento" className="form-label">Tipo Lançamento</Label>
                                                            {/* <SelectListControlled<ContasBancariasSearch>
                                                ...
                                                <Row className="mt-5">
                                                    <div className="d-flex flex-row justify-content-end align-items-center" >
                                                        ...
                                                        <Col md={6}>
                                                            <div className="ms-4 ">
                                                                <InputTextControlled<ContasBancariasSearch> field={"palavra_chave"} control={control} placeholder="Buscar..." />
                                                            </div>
                                                        </Col>
...
export default ContasBancariasFilter;     