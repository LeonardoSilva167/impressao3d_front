...
import { CoresSearch } from "interfaces/Cores/CoresInterface"

export interface CoresFilterProps {
    getRemoteCoresList: (data: any) => void
}

const CoresFilter = ({ getRemoteCoresList }: CoresFilterProps) => {
    const { handleSubmit, control, register } = useForm<CoresSearch>({ defaultValues: {} })
                        ...
                        <CardHeader>
                            <div className="gap-2 flex-wrap">
                                <Row>
                                    ...
                                    {!showFilter && (
                                        <Col md={8}>
                                            <form onSubmit={handleSubmit(getRemoteCoresList)}>
                                ...
                                <Col>
                                    <Collapse isOpen={showFilter} className="multi-collapse mt-3">
                                        <form
                                            ...
                                            id="form-search"
                                            onSubmit={handleSubmit(getRemoteCoresList)}
                                        >
                                            <Row>
                                                <Col md={4}>
                                                    <div className="mb-3">
                                                        <label htmlFor="descricao" className="form-label">Descrição</label>
                                                        <InputTextControlled<CoresSearch>
                                                            field={"descricao"}
                                                            control={control}
