...
export interface CoresTableProps {
    data: PaginateInterface<CoresList> | undefined
    getData: (data: PaginateSearch & CoresSearch) => void
...
export const CoresTable = ({ data, getData, setPerPage, setPage, perPage, filters }: CoresTableProps) => {
    ...
    const handleRemoteDelete = async (id: number) => {
        try {
            await coresService.deleteCores(id)
                                                                        ...
                                                                        <ButtonGroup>
                                                                            <UncontrolledDropdown direction="down">
                                                                                ...
                                                                                <DropdownMenu style={{ zIndex: '999' }}>
                                                                                    <Link to={`/cores/view/${row.id}`} state={{ source: row }}>
                                                                                        <DropdownItem>Visualizar</DropdownItem>
                                                                                    </Link>
                                                                                    <Link to={`/cores/edit/${row.id}`} state={{ source: row }}>
