import { VendasDefaultValues, VendasModel } from "interfaces/Vendas";
import React, { useState } from "react";
import { useForm } from "react-hook-form";
import { Link, useLocation } from "react-router-dom";
import { Breadcrumb, BreadcrumbItem, Card, CardBody, CardHeader, Col, Container, Row, Table } from "reactstrap";

const FluxoCaixaReport = () => {
                    ...
                    <Col xs={12}>
                        <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                            {/* <div className='d-sm-flex align-items-center justify-content-between'>
                                <Link to="/vendas"> <i className="bx bx-arrow-back bx-sm"></i> </Link>
                                <h4 className="mb-sm-0 ms-3">Adicionar Venda</h4>
                            </div> */}
                            <Breadcrumb pageTitle="Adicionar Contas Bancarias" listClassName='mb-sm-0 pt-1 py-2'>
                                <BreadcrumbItem> <Link to="/dashboard"> <i className="ri-home-5-fill"></i> </Link> </BreadcrumbItem>
                                <BreadcrumbItem> <Link to="/vendas"> Fluxo de Caixa </Link> </BreadcrumbItem>
                                <BreadcrumbItem active> Adicionar Fluxo de Caixa </BreadcrumbItem>
                            </Breadcrumb>
                        </div>
                    </Col>
...
export default FluxoCaixaReport;