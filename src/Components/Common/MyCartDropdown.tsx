...
const MyCartDropdown = () => {
    ...
    const removeItem = (ele: HTMLElement | null): void => {
        if (ele) {
            ...
            // const priceElement = ele.closest(".dropdown-item-cart")?.querySelector('.cart-item-price');
            const dropdownItemCart = ele.closest(".dropdown-item-cart");
            const priceElement = dropdownItemCart ? dropdownItemCart.querySelector('.cart-item-price') : null;
