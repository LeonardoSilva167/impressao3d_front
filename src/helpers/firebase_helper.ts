...
class FirebaseAuthBackend {
  ...
  addNewUserToFirestore = (user: any) => {
    ...
    const details = {
      ...
      firstName: profile && profile.given_name ? profile.given_name : profile && profile.first_name,

      // lastName: profile?.family_name ? profile.family_name : profile?.last_name,
      lastName: profile && profile.family_name ? profile.family_name : profile && profile.last_name,

      // fullName: profile?.name,
      fullName: (profile && profile.name) || undefined,

      // email: profile?.email,
      // picture: profile?.picture,
      email: (profile && profile.email) || undefined,
      picture: (profile && profile.picture) || undefined,
